  ...
  return (
    <section className="section-shell pt-24 sm:pt-28">
      <motion.div
        ...
        className="card-frame overflow-hidden px-6 py-14 text-center sm:px-10"
      >
        <p className="tracking-[0.35em] text-goldSoft/80 uppercase">{weddingContent.hero.label}</p>
        <h2 className="mt-5 font-script text-6xl text-gold sm:text-8xl">{weddingContent.hero.names}</h2>
